...
?>
    ...
    <h1 class="mt-2"><i class="fa fa-university"></i></h1>
        ...
        <div class="container">
        <div class="card">
                    <h5 class="text-center mt-3"></i><i class="fas fa-map-marker-alt"></i> <?php echo $rec['cdist']?>,<?php echo $rec['ccity']?>, <?php echo $rec['cadd']?>, <?php echo $rec['cpin']?>, <i class="fa fa-phone"></i><a href="tel:9876543210"> <?php echo $rec['cphone']?></a>
                    <center>
        ...
        <div class="col-12">
            ...
            <form name="<?php echo $rec['cname']?>" action="stureg.php" method="post">
                <input type="hidden" name="colid" value="<?php echo $rec['colid']?>">
                <input type="submit" class="btn btn-warning col-12 btn-lg text-dark" value="Register To Apply">
            </form>
            </div>
        </div>
        <?php
